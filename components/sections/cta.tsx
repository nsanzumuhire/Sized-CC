...
export function CTA() {
  ...
  return (
    <section className="py-32 relative overflow-hidden bg-neutral-50 dark:bg-black border-t border-black/5 dark:border-white/5 flex items-center justify-center min-h-[500px]">
      <BackgroundBeams className="opacity-10 dark:opacity-20" />
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 mb-8">
          ...
          <h2 className="text-5xl md:text-7xl font-bold font-heading text-black dark:text-white mb-6 tracking-tight">
