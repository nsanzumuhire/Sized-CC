...
const features = [
  {
    ...
    description:
      "Laser-guided cutting and fabrication accurate to the millimeter.",
    icon: Ruler,
  },
  {
    title: "Durable Materials",
    description:
      "Sourced from top-tier suppliers to ensure longevity and strength.",
    icon: ShieldCheck,
  },
  {
    title: "Skilled Craftsmanship",
    description:
      "Expert welders and fabricators with decades of combined experience.",
    icon: Award,
  },
  {
    title: "On-Time Delivery",
    description:
      "Rigorous project management to ensure your deadlines are met.",
    icon: Clock,
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              We don&apos;t just cut metal; we engineer solutions. Our commitment to
              precision and durability makes us the preferred partner for
          ...
          <div className="relative h-[400px] w-full bg-neutral-900 rounded-none border border-white/10 overflow-hidden group">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-9xl font-bold text-white/5 font-heading select-none">
                100%
              </span>
            </div>
          </div>
