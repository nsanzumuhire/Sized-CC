  ...
  return (
    <section className="py-32 relative overflow-hidden bg-neutral-950 border-t border-white/10 flex items-center justify-center min-h-[500px]">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg font-bold h-16 px-12 rounded-none shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:shadow-[0_0_50px_rgba(249,115,22,0.5)] transition-all duration-300 scale-100 hover:scale-105">
          Request a Quote
        </Button>
      </div>
    </section>
